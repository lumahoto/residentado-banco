# Residentado WebApp v1.4.3 — hardening de sincronización y outbox
...
1. Reemplazar el runtime/repo por v1.4.3 y publicar normalmente.
2. Abrir la WebApp con conexión y confirmar que el pie muestra `v1.4.3`.
...
## Smoke específico v1.4.3

1. Abrir una sesión normal y responder 2 preguntas.
2. Cerrar/continuar y comprobar que no aparecen copias de recuperación espontáneas.
3. Si se fuerza un conflicto con dos pestañas, una copia atrasada que no contiene progreso único debe ser descartada a favor del remoto.
4. Una recuperación legítima con respuestas heredadas no debe crear nuevos attempts al cerrarse sin responder nada nuevo.
