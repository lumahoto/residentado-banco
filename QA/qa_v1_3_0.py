...
# Release/versioning.
require("version: '1.3.0'" in version, 'version.js no declara 1.3.0')
require("cacheName: 'residentado-v1-3-0'" in version, 'version.js no declara el caché 1.3.0')
