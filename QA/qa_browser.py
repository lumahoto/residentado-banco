#!/usr/bin/env python3
"""Smoke UI sin red para v1.4.2: Taxonomía V3/A16 + paridad de práctica. Requiere Python Playwright y Chromium."""
...
with sync_playwright() as p:
    ...
    assert 'v1.4.2' in page.locator('body').inner_text()
    ...
    # v1.4.2 hereda de v1.4.1: una práctica personalizada cronometrada conserva la acción No sé.
...
print('QA navegador v1.4.2 SYNC HARDENING: OK')
