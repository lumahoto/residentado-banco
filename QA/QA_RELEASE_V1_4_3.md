...
## Guardrails estáticos específicos v1.4.3
...
Smoke manual corto con dos pestañas y tres preguntas, descrito en `docs/INSTRUCCIONES_APLICACION_V1_4_3.md`. No requiere volver a exportar logs antes de comenzar a estudiar si el smoke pasa.

## Regresiones v1.4.3

- Un snapshot local que es prefijo exacto del remoto no crea recuperación.
- Cerrar una recuperación con respuestas heredadas y sin respuestas nuevas crea 0 attempts nuevos y no mueve attempts históricos.
- Modificar explícitamente una respuesta heredada separa su identidad y genera exactamente 1 attempt nuevo.
